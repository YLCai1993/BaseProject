...
- (YLImageView *)iconView1 {
    if(_iconView1 == nil) {
        _iconView1 = [[YLImageView alloc] init];
...
- (YLImageView *)iconView2 {
    if(_iconView2 == nil) {
        _iconView2 = [[YLImageView alloc] init];
...
- (YLImageView *)iconView3 {
    if(_iconView3 == nil) {
        _iconView3 = [[YLImageView alloc] init];
...
- (YLImageView *)iconView4 {
    if(_iconView4 == nil) {
        _iconView4 = [[YLImageView alloc] init];
...
- (YLImageView *)iconView5 {
    if(_iconView5 == nil) {
        _iconView5 = [[YLImageView alloc] init];
